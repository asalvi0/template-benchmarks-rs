...
use template_benchmarks_rs::{
    ...
    mini_jinja, ructe, sailfish, std_write, tera,
};
...
fn big_table(c: &mut Criterion) {
    ...
    group.bench_with_input("MiniJinja", &input, mini_jinja::big_table);
...
fn teams(c: &mut Criterion) {
    ...
    group.bench_with_input("MiniJinja", &input, mini_jinja::teams);
